...
You should probably learn the [rules of _Cards Against Humanity_](https://s3.amazonaws.com/cah/CAH_Rules.pdf) before
using this API.
...
| includePackNames | boolean  | Whether to include the name of each card's originating pack in the response.                                                                                               | No            | False       |
...
```json
{
  ...
  "properties": {
    ...
    "white": {
      "title": "White",
      "type": "array",
      "items": { "$ref": "#/definitions/WhiteCard" }
    }
  },
  ...
  "definitions": {
    "BlackCard": {
      ...
      "properties": {
        ...
        "pack": { "title": "Pack", "type": "string" },
        "pick": { "title": "Pick", "type": "integer" }
      },
      "required": ["text", "pack", "pick"]
    },
    "WhiteCard": {
      "title": "WhiteCard",
      "type": "object",
...
axios.get("https://restagainsthumanity.com/api/v2/cards", {
    params: {
